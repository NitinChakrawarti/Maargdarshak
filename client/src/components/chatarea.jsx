...
// const ChatArea = React.memo(({ selectedUser, setSelectedUser, isMobile, newMessage, setNewMessage, handleBackToList, }) => {
...
//                                 src={selectedUser?.profile || "https://via.placeholder.com/150"} // Placeholder image if no profile picture  
...
//                         }
//                         {/* <div
//                             className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 border-white ${selectedUser.status === "online" ? "bg-green-500" : "bg-gray-400"
//                                 }`}
//                         ></div> */}
//                     </div>
//                     <div>
...
//                             {/* <span
//                                 className={`text-xs py-0.5 px-2 rounded-full ${selectedUser.status === "online"
...
//                                         ) : (
//                                             <div
//                                                 className={`max-w-[75%] rounded-2xl px-4 pt-2.5 shadow-sm ${isUserMessage

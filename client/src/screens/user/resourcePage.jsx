...
const ResourcePage = () => {
    return (
        ...
        <div className='md:py-4 px-4 md:px-4 max-w-7xl mx-auto'>
            <div className="bg-gradient-to-br mt-4 from-[#1e293b] via-[#1a3a6c] to-[#1e3a8a] rounded-lg px-8 py-4 overflow-hidden relative">

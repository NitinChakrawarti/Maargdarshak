          ...
          <div className='pt-4 px-4 md:px-4 max-w-7xl mx-auto'>
            <div className="bg-gradient-to-br from-[#1e293b] via-[#1a3a6c] to-[#1e3a8a] rounded-lg px-8 py-4 overflow-hidden relative">
              ...
              <div className="relative z-10">
                <h1 className="text-2xl font-bold text-white mb-2">About मार्गदर्शक</h1>
                <p className="text-[#b5d5e5] mb-6">Your go-to platform for personalized career guidance and resources.</p>
              </div>
            </div>
          </div>
